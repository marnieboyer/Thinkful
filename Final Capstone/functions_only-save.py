...
image_dir = "C:/Users/boyerm/_Capstone 3 Final/pics"   #celebrity search version
...
def make_face_df2_save(image_select,filenum):
    
    # need to clean up this function to remove 2 uses of same process
   ...
   # filenum = 0   # need this to iterate through the dataframe to append rows
    ...
    for face_landmarks in face_landmarks_list:
        ...
        #pil_image.show()
       # pil_image.save(str(image_select)+"original.jpg")
       #print(pts)

      
    
######## New - new - crop and align ##   
